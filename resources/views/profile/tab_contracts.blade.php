<div class="tab-pane fade justify-content-center" id="navs-contracts-card" role="tabpanel">
    <div class="d-flex justify-content-end mb-3">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addcontractsModal">
            <i class="mdi mdi-plus"></i>اطلاعات قرارداد ها
        </button>
    </div>
    <div class="modal fade" id="addcontractsModal" tabindex="-1" aria-labelledby="addcontractsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">اطلاعات قرارداد ها</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="بستن"></button>
                </div>
                <div class="card-body">
                    <div class="modal-body">
                        <form onsubmit="handleCreate(this); return false;" id="addform" class="row g-4 mb-4" data-table-target="#contract" action="{{ route('contract.store') }}" method="POST">
                            @csrf
    ...
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table id="contracts" class="table table-striped table-bordered yajra-datatable">
                    <thead>
...
{{--                const contractsTable = $('#contracts.yajra-datatable').DataTable({--}}
{{--                    processing: true,--}}
{{--                    serverSide: true,--}}
{{--                    ajax: {--}}
