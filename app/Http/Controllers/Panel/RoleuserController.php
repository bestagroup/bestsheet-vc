            ...
            return Datatables::of($data)
                ...
                ->editColumn('action', function ($data) {
                    ...
                    if (Gate::allows('can-access', ['roleuser', 'delete'])) {
                        ...
                        $actionBtn .= '<button class="'.$base.' btn btn-sm btn-icon btn-outline-danger" data-bs-toggle="modal" data-bs-target="#permissionsModal'.$data->id.'"><i class="mdi mdi-access-point"></i></button>';
