    ...
    public function index(Request $request){
        ...
        if ($request->ajax()) {
            $data = MediaFile::leftjoin('projects', 'projects.id', '=', 'media_files.project_id')
                ...
                ->select('media_files.id' , 'media_files.file_path' , 'media_files.name' , 'media_files.original_name' , 'media_files.type' , 'media_files.size' , 'media_files.updated_at' , 'projects.title' , 'projects.company_name' , 'subject_files.title as step')->get();
