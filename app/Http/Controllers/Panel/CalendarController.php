...
dd( [
        Carbon::parse(Jalalian::fromFormat('Y-m-d\TH:i:s', $request->eventStartDate)->toCarbon())
        ->format('Y-m-d\TH:i:s'),
        Carbon::parse(Jalalian::fromFormat('Y-m-d\TH:i:s', $request->eventEndDate)->toCarbon())
        ->format('Y-m-d\TH:i:s')
    ]);
        $event = new Event([
